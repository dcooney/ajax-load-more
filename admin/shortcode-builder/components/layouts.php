   	            ...
   	            <h4><?php _e('Column/Row Gap', 'ajax-load-more'); ?></h4>
					...
					<div class="shortcode-builder--fields">
						<select class="alm_element" name="layouts-gap" id="layouts-gap">
							<option value="default" selected="selected"><?php _e('Default', 'ajax-load-more'); ?></option>
							<option value="md"><?php _e('Medium', 'ajax-load-more'); ?></option>
							<option value="sm"><?php _e('Small', 'ajax-load-more'); ?></option>
